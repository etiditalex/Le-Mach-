    ...
    <section className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-3xl md:text-5xl font-sans font-bold text-primary">
        ...
        <div className="relative overflow-hidden rounded-none group">
          <div
            className="flex gap-6 will-change-transform [animation:lemach-marquee_var(--lemach-speed)_linear_infinite] group-hover:[animation-play-state:paused]"
          ...
          >
            {loopSlides.map((slide, index) => (
              ...
              >
                <div className="grid grid-cols-12 gap-4 h-72 sm:h-80 lg:h-[420px]">
